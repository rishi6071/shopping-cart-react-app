...
const NewsGrid = (props) => {
  ...
  return (
    <div className={classes.root}>
                      ...
                      <Grid container>
                        ...
                        <Grid item sm={7} xs={12}>
                          <CardContent style={{ padding: "15px 0px 13px 18px" }}>
                            <Container disableGutters className={classes.horizontalNewsContentBox}>
                              <Typography gutterBottom className={classes.newsName}>
                                {newsCard.name}
                              </Typography>
                              <Typography className={classes.newsSource}>
                                By {newsCard.provider[0].name} [{filterDate(newsCard.datePublished)}]
                              </Typography>
                              <Typography variant="body2" component="p" className={classes.newsDescription}>
      ...
      {/* NEWS AliceCarousel */}
      <SectionHeader title="newsPanel" style={{ display: showNewsCarousel === true ? "block" : "none" }} />
      <Grid container className={classes.paddingPart} style={{ display: showNewsCarousel === true ? "block" : "none" }}>
        <AliceCarousel
          autoPlay
                  ...
                  <CardActionArea>
                    ...
                    <CardContent style={{ padding: "15px 0px 20px 15px" }}>
                      <Container disableGutters className={classes.newsContentBox}>
                        ...
                        <Typography style={{ marginTop: 5 }} className={classes.newsSource}>
                          By {newsfeed.provider[0].name} [{filterDate(newsfeed.datePublished)}]
                        </Typography>
                        <Typography
                          variant="body2"
                          component="p"
                      ...
                      <Button variant="contained" className={classes.newsBtn} href={newsfeed.url} target="_blank">
                        Read More
                      </Button>
                    </CardContent>
                  </CardActionArea>
